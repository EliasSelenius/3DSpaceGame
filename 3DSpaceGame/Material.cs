...
namespace _3DSpaceGame {
    public struct Material {
        ...
        public static Material Sun => new Material {
            ambient = new vec3(255, 225, 0) / 255,
            diffuse = new vec3(255, 225, 0) / 255,
            specular = vec3.one,
            shininess = 1f,
            emission = new vec3(255, 225, 0) / 255
        };
        ...
        public static Material Obsidian => new Material {
            ...
            diffuse = new vec3(0.18275f, 0.17f, 0.22525f),
        ...
        public static Material Pearl => new Material {
            ...
            diffuse = new vec3(1f, 0.829f, 0.829f),
        ...
        public static Material Ruby => new Material {
            ...
            diffuse = new vec3(0.61424f, 0.04136f, 0.04136f),
        ...
        public static Material Turquoise => new Material {
            ...
            diffuse = new vec3(0.396f, 0.74151f, 0.69102f),
        ...
        public static Material Brass => new Material {
            ...
            diffuse = new vec3(0.780392f, 0.568627f, 0.113725f),
        ...
        public static Material Bronze => new Material {
            ...
            diffuse = new vec3(0.714f, 0.4284f, 0.18144f),
        ...
        public static Material Chrome => new Material {
            ...
            diffuse = new vec3(0.4f, 0.4f, 0.4f),
        ...
        public static Material Copper => new Material {
            ...
            diffuse = new vec3(0.7038f, 0.27048f, 0.0828f),
        ...
        public static Material Gold => new Material {
            ...
            diffuse = new vec3(0.75164f, 0.60648f, 0.22648f),
        ...
        public static Material YellowRubber => new Material {
            ...
            diffuse = new vec3(0.5f, 0.5f, 0.4f),
